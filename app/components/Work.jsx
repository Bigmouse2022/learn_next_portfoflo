...
const Work = () => {
  return (
    ...
    >
      ...
      <h2 className="text-center text-5xl font-Ovos">My latest work</h2>
      ...
      <a className="w-max flex items-center justify-center gap-2
      text-gray-700 border-[0.5px] border-gray-700 rounded-full 
      py-3 px-10 mx-auto my-20 hover:bg-light-hover duration-500" href="">Show more<Image src={assets.right_arrow_bold} alt="Right arrow"
      className="w-4" /></a>
    </div>
  );
};
