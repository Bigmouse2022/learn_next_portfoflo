...
const Navbar = () => {
  ...
  return (
    <>
      ...
      ${isScroll ? " bg-opacity-50 backdrop-blur-lg shadow-sm":"bg-white"}`}>
        <a href="#top">
          <Image src={assets.logo} alt="" className="w-28 cursor-pointer mr-14" />
        </a>

        <ul className={`hidden md:flex items-center gap-6 lg:gap-8 
        rounded-full px-12 py-3 ${isScroll? "white":" shadow-sm bg-opacity-40 "}`}>
        ...
        <div className="flex items-center gap-4">
            ...
            px-10  py-2.5 border border-gray-500 rounded-full ml-4 font-Ovo">
                Contact <Image src={assets.arrow_icon} alt=""
            className="w-3" /></a>
